...
public:
    ...
    void ShootCtrl(bool shoot_ready, bool friction_ready, float shoot_speed);
    void PushControl(float read_or_not);
...
private:
    ...
    TrapePlanner PushPlanner = TrapePlanner(0.25,0.25,2500,10,1);    // 加速路程比例，减速路程比例，最大速度，起始速度，死区大小
    /*     新   加   的   ↓     */
